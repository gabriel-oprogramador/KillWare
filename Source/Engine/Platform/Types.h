...
typedef enum ETargetPlatform {
  TARGET_PLATFORM_UNKNOW,   //
  TARGET_PLATFORM_WINDOWS,  //
  TARGET_PLATFORM_LINUX,    //
  TARGET_PLATFORM_WEB,      //
} ETargetPlatform;

typedef enum ETargetRenderer {
  TARGET_RENDERER_UNKNOW,      //
  TARGET_RENDERER_GL_CORE_33,  //
  TARGET_RENDERER_GL_ES_30,    //
} ETargetRenderer;
